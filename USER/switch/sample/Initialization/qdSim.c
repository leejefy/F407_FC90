...
void qdSimRegsInit()
{
    ...
    /* 
        PHY Registers Setup
    */
    printf("===[%s] %d >>reg init 0 -- qdSimNumOfPhys=%d\r\n",__FILE__,__LINE__,qdSimDev.qdSimNumOfPhys);
    ...
    */
        printf("=[%s] %d >>==qdSimRegsInit == qdSimNumOfPorts+qdSimPortBase[%d]=%d == \r\n",__FILE__,__LINE__,qdSimDev.qdSimPortBase,qdSimDev.qdSimNumOfPorts+qdSimDev.qdSimPortBase);
    ...
    */
    printf("==[%s] %d >>=qdSimRegsInit ==qdSimGlobalRegBase=%d == \r\n",__FILE__,__LINE__,qdSimDev.qdSimGlobalRegBase);
