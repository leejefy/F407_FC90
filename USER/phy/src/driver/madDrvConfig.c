...
)
{
    ...
    MAD_U16     id1, id2;
    MAD_STATUS  retVal;
     MAD_DBG_INFO(("madDriverConfig called dev->baseRegAddr=%x\r\n",dev->baseRegAddr));
    /* Set page as 0 */
	...
	MAD_DBG_INFO(("madDriverConfig MAD_OK MAD_REG_PAGE_ADDR[%x] retVal=%d\r\n",MAD_REG_PAGE_ADDR,retVal));
	...
	MAD_DBG_INFO(("madDriverConfig MAD_OK MAD_REG_PHY_ID_1 retVal=%d,id1=%x\r\n",retVal,id1));
	...
	MAD_DBG_INFO(("madDriverConfig MAD_OK MAD_REG_PHY_ID_2 retVal=%d,id2=%x\r\n",retVal,id2));
	...
	MAD_DBG_INFO(("[%s] %d >> madDriverConfig OK deviceId=%x,revision=%x\r\n",__FILE__,__LINE__,dev->deviceId,dev->revision));
